...
Partial Class Presentation_CMS_Bird_AddBird
...
#End Region
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim result As Boolean = BirdAction.Insert(ddlCategory.SelectedValue, txtName.Text, txtScinceName.Text, txtFood.Text, txtZone.Text, txtDescription.Text, RadioButtonList1.SelectedValue, intCount, intPrice)
        If result Then
            HiddenField1.Value = BirdAction.GetLastID()
    ...
    Protected Sub btnSendPic_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSendPic.Click
        ...
        Dim CurrentID As Integer = BirdAction.GetLastID()
