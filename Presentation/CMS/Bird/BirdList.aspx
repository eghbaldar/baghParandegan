<%@ Page Language="VB" MasterPageFile="~/Presentation/MP_Management.master" AutoEventWireup="false" CodeFile="BirdList.aspx.vb" Inherits="Presentation_CMS_Bird_BirdList" title="لیست حیوانات باغ" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        DeleteMethod="Delete" 
        SelectMethod="SelectAllBirdInfo" TypeName="Bird">
        <DeleteParameters>
