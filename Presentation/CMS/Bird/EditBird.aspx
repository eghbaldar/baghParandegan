<%@ Page Language="VB" MasterPageFile="~/Presentation/MP_Management.master" AutoEventWireup="false" CodeFile="EditBird.aspx.vb" Inherits="Presentation_CMS_Bird_EditBird" title="ویرایش مشخصات" %>
            ...
            <table cellspacing="4">
                ...
                <tr style="height:50px;">
                    <td>
                        &nbsp;</td>
                    <td>
                        <asp:Button ID="btnSave" runat="server" Text="بروز رسانی" Width="80px" />
                    </td>
                    <td>
                        &nbsp;</td>
                    <td>
...
--%>                            
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT ID, BirdID, Title, ThumbnailName FROM Tbl_BirdPicture WHERE (BirdID = @BirdID)" 
                            DeleteCommand="DELETE FROM Tbl_BirdPicture WHERE (ID = @ID)">
                            <SelectParameters>
                                <asp:QueryStringParameter Name="BirdID" QueryStringField="ID" />
                            </SelectParameters>
                            <DeleteParameters>
